...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    CompletableFuture<Void> seckillFuture = CompletableFuture.runAsync(() -> {
        ...
        R skuSekillInfo = seckillFeignService.getSkuSeckillInfo(skuId);
        if (skuSekillInfo.getCode() == 0) {
            //查询成功
            SeckillSkuVo seckilInfoData = skuSekillInfo.getData("data", new TypeReference<SeckillSkuVo>() {
            });
